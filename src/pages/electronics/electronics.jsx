...
const Electronics =()=>{
    ...
    useEffect(()=>{
        try {
            const fetchData =async()=>{
                ...
                const FilterClothdata = data.filter((item)=>item.category.name==="Electronics")
                setElectronicsData([...FilterClothdata])
            }
    ...
    return(
        <div className="Electronics">
            ...
            <div className="Electronics-1">
                <h1>Electronics</h1>
                <input type="text" placeholder="search a product"/>
            </div>
            <div className="Electronics-2">
                {ElectronicsData.length===0 ?
                
                <div className="Electronics-2-1">
